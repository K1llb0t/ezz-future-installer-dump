...
public abstract class Ni {
    ...
    private /* synthetic */ Ni v;

    /*
     * Exception decompiling
     */
    public /* synthetic */ X7 S(Object[] this) {
        /*
    ...
    public static /* synthetic */ {
        int n2;
        long l2 = wu.a(2043324023064639272L, 214068982833617091L, MethodHandles.lookup().lookupClass()).a(108483871720881L) ^ 0x4AB84DCDCB57L;
        ...
        while (true) {
            if (n3 >= 8) {
                ...
                b = Ni.a(cipher.doFinal(N8.C("\u0082\u0004_\u008d|\u00f2\u00d9Xq\u00f1\u00c5c\u00b5\u0015\t\u00d9\u00b0K\u00be\u000bU\u00bc\u00f7\u00ce\u00f8g\u00970r\u0082\u00dd\u00c4").getBytes(J.C("\\)]P-B=^o\u001c")))).intern();
                return;
            }
            arrby2 = arrby2;
            int n4 = n2++;
     ...
     * Exception decompiling
     */
    public /* synthetic */ X7 N(Object[] this) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public /* synthetic */ void z(Object[] this) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [0[TRYBLOCK]], but top level block is 4[CATCHBLOCK]
         * org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.processEndingBlocks(Op04StructuredStatement.java:429)
